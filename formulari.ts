...
function esContrasenaValida(contrasena: string): boolean {
...
contrasenaInput.addEventListener("input", () => {
  ...
  const contrasena: string = contrasenaInput.value.trim();
...
const formulario: HTMLFormElement = document.getElementById("mainForm") as HTMLFormElement;
